...
BatHat.prototype =
{
	...
	listen: function(port)
	{
		...
		{
			// -----------------------------------------------------------------
			// Setting up the connection for each model.
			// -----------------------------------------------------------------
			for(var model in root.models)
			{
				root.models[model].name = model;
				root.models[model].setDb(db);
			}
			// -----------------------------------------------------------------
	...
	// PUT  /items/1/update 	"update"	=> Update an item and returns it.
	// DELETE  /items/1/destroy	"destroy"	=> Deletes an item.
	// -------------------------------------------------------------------------
	//
